...
Certified on 2026-07-13 against parser-content commit `e38a509720eb54652d7079380acaa62064a2c66a` after independent-review remediation, nested element-content coverage, and inline implicit-expression block-boundary hardening.

## Julie Extractors handoff

- Pin the Razor parser to `e38a509720eb54652d7079380acaa62064a2c66a`.
- Parser ABI: 15.
...
|---|---|---|---|
| Clean Node floor and binding contract | `npm ci`, generation, generated-source diff, `npm test` under Node 22.17.0 | branch gate at parser pin | 10/10 passed; no generated drift |
| Official and full corpus | `tree-sitter test --stat total-only` plus focused nested-element and inline-block coverage | diagnostic branch gate at parser pin | 148/148 corpus cases and all 42 highlight assertions passed |
